...
fun Route.alertRoutes(
    ...
    get("/api/campsite/alerts", {
        ...
        description = "Deprecated rec.gov-only alert path; prefer reservable availability poller endpoints."
    }) {
    ...
    post("/api/campsite/alerts", {
        ...
        description = "Deprecated rec.gov-only alert path; prefer POST /api/reservable/{rid}/availability/poller."
    }) {
