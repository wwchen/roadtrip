 ...
 */
class CachedRecGovAvailability(
    ...
    private val log = LoggerFactory.getLogger(CachedRecGovAvailability::class.java)
...
private fun CachedRecGovAvailability.Key.persistentKey(): String = listOf(provider, campgroundId, month).joinToString(":")

data class CachedRecGovResult(
