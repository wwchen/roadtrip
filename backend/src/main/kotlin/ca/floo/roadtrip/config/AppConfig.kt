...
data class AppConfig(
    ...
    /** Cross-origin allowlist for browser callers on another origin (local
     *  Grafana → backend action POSTs), or null when unset (same-origin only). */
    val cors: CorsConfig?,
) {
    companion object {
