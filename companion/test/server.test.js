...
test('GET / returns a simple operator login form', async () => {
  ...
  assert.ok(response.text.indexOf('id="health-json"') < response.text.indexOf('id="toggle-atc"'))
  assert.ok(response.text.indexOf('id="toggle-atc"') < response.text.indexOf('id="refresh-session"'))
  assert.ok(response.text.indexOf('id="refresh-session"') < response.text.indexOf('id="toggle-login"'))
  assert.ok(response.text.indexOf('id="toggle-login"') < response.text.indexOf('id="logout-session"'))
  assert.match(response.text, /id="toggle-atc" class="toggle secondary"/)
  assert.match(response.text, /id="toggle-login" class="toggle"[^>]*>Log in/)
  assert.match(response.text, /id="logout-session" type="button">Log out/)
