...
That path is the same on every host regardless of OS — see
[secrets.md](secrets.md#1-create-your-key). Once the branch is checked out
here, `make secrets-init` does the same thing and is idempotent.
