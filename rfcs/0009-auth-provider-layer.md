...
| 13 | 2026-07-26 | One new dependency: `com.nimbusds:nimbus-jose-jwt`. No identity-provider SDK. | ID-token verification is the layer's most security-sensitive code and the wrong place to hand-roll crypto. Nimbus is the standard JOSE implementation and is vendor-neutral, so it does not compromise decision 1. |
