...
test('flattenHydratedPoi promotes canonical Campflare fields for the drawer', () => {
  ...
  assert.deepEqual(p.price, campflareDetail.properties.detail.raw.price);
  assert.deepEqual(p.schedule, campflareDetail.properties.detail.raw.default_campsite_schedule);
  ...
  assert.deepEqual(p.links, campflareDetail.properties.detail.raw.links);
  assert.deepEqual(p.alerts, campflareDetail.properties.detail.raw.alerts);
  assert.deepEqual(p.connections, campflareDetail.properties.detail.raw.connections);
