...
test('fetchPoiCampsites returns canonical campsite catalog rows', async () => {
  ...
  assert.deepEqual(json.campsites, [{ id: 1, data_provider: 'recgov', data_provider_ref: '100' }]);
  assert.deepEqual(json.reservation_url_templates, { 1: 'https://example.test/{start_date}' });
});
